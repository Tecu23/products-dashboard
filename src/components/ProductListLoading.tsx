    ...
    return (
        <div className="w-full h-full flex flex-col gap-8">
            {[...Array(5)].map((_, idx) => (
                <div
                    key={idx}
                    className="h-[570px] flex flex-row gap-4 items-center bg-neutral-100 rounded-lg shadow-md px-4 lg:px-8 py-4 hover:shadow-lg w-full max-w-2xl animate-pulse"
                >
